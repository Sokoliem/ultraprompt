...
Deep-budget or high-consequence versions of this lane can escalate to: `prd-panel`, `mvp-panel`. Preferred: `prd-panel`. Use panel escalation for independent specialist breadth; keep the default path lighter for ordinary requests.
