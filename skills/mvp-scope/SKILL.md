---
name: "mvp-scope"
description: "**DEFAULT for MVP scoping decisions: produces structured MVP scope with must/should/won't-have per phase, scope cuts with reasoning, validation plan for what we keep, and what we'd add post-MVP: runs the mvp-scope discipline.** Different from prd-to-plan (sequences the whole PRD) and prd-lite (drafts the PRD itself)."
...
```yaml
schema:
  - field: Hypothesis MVP validates
    type: section
    required: true
    evidence_rule: "none"
  - field: Must-have
  ...
  - field: Should-have
    ...
    required: true
    evidence_rule: "none"
  - field: Won't-have-this-MVP with cut reasons
    type: section
    required: true
    evidence_rule: "none"
  ...
  - field: Success criteria
    ...
    required: true
    evidence_rule: "none"
  - field: Failure criteria
    type: section
    required: true
    evidence_rule: "none"
  - field: Post-MVP roadmap sketch
    type: section
    required: true
    evidence_rule: "none"
```
